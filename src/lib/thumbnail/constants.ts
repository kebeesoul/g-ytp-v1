export const FONTS = [
  ...
  },
  {
    ...
    label: "OFFICE CODE PRO",
    family: "'Office Code Pro', monospace",
    googleKey: null,
    weight: "700",
    spacing: "0.04em",
    italic: false,
  ...
  },
  {
    ...
    name: "Ostrich Sans",
    label: "OSTRICH SANS",
    family: "'Ostrich Sans', sans-serif",
    googleKey: null,
    weight: "400",
    spacing: "0.18em",
    italic: false,
  ...
  {
    id: "terminalgrotesque",
    name: "Terminal Grotesque",
    label: "TERMINAL GROTESQUE",
