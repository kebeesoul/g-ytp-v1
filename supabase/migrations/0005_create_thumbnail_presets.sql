create table public.thumbnail_presets (
  ...
  font_id      text not null default 'bebas',
  overlay_id   text not null default 'bottom',
  position_id  text not null default 'bottom',
  color_id     text not null default 'white',
  text         text not null default 'PLAYLIST',
  text_size_px smallint not null check (text_size_px >= 50 and text_size_px <= 280) default 148,
